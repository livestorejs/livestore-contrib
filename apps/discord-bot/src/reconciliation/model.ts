...
export type ReconciliationMode = { readonly _tag: 'Plan' } | { readonly _tag: 'Apply'; readonly reason: string }
...
export class ThreadObservationError extends Schema.TaggedError<ThreadObservationError>()('ThreadObservationError', {
  message: Schema.String,
  cause: Schema.Defect(),
}) {}
