...
const WorkerInput = Schema.Tuple([Schema.String, Schema.String, Schema.String, JournalTrigger])

const program = Effect.gen(function* () {
  const [path, sourceMessageIdRaw, channelIdRaw, trigger] = yield* Schema.decodeUnknownEffect(WorkerInput)(
