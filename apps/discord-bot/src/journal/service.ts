...
export class JournalUnavailableError extends Schema.TaggedError<JournalUnavailableError>()(
...
export class JournalTransitionError extends Schema.TaggedError<JournalTransitionError>()(
...
export interface ThreadActionJournalService {
  ...
  readonly observeAmbiguity: (
    input: ObserveAmbiguityInput,
  ) => Effect.Effect<ThreadActionRecord, JournalWriteError>
