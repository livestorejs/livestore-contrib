...
export class DiscordActionError extends Schema.TaggedError<DiscordActionError>()(
  "DiscordActionError",
  {
...
export interface DiscordActionsService {
  ...
  readonly editInteractionResponse: (
    message: InteractionMessage,
  ) => Effect.Effect<void, DiscordActionError>
  readonly followUpInteractionResponse: (
    message: InteractionMessage,
  ) => Effect.Effect<void, DiscordActionError>
...
export class DiscordActions extends Context.Service<
  DiscordActions,
