...
describe("deployment contract", () => {
  ...
  it.each([
    ...
    ["overlapping docs audience", { ...base, docsAudience: { ...base.docsAudience, roleRestrictedChannelIds: base.docsAudience.publicChannelIds } }],
    ["restricted audience without role", { ...base, docsAudience: { ...base.docsAudience, roleRestrictedChannelIds: ["100000000000000003"] } }],
