...
baseline evidence. Model backend unavailability at a Scenario-owned
participant-route proxy rather than adding Scenario controls to the sync
engine. Decision 0008 adds an explicitly selected deployed `sync-cf`
realization across compatible profiles without changing this placement model.
