  ...
  instructions: [
    {
      ...
      text: 'The initial Client commits and confirms history before the second Client exists.',
    },
    repeatActions({
      id: 'initial-history',
    ...
    },
    {
      _tag: 'annotation',
      id: 'late-join',
      text: 'Client B is created from empty local state and both Clients write before final settlement.',
    },
    {
      _tag: 'create-client',
      id: 'create-client-b',
