...
import { participantHostFailure, ScenarioOperationError } from '../application/definition.ts'
...
import type { HostError, ParticipantHost } from './contract.ts'
import { inProcessHostCapabilities, makeInProcessHost } from './in-process/host.ts'
import { makeProcessHost, processHostCapabilities } from './process/host.ts'
